...
import pw.binom.FileSystemManager
import pw.binom.LocalFileSystemManager
import pw.binom.PlaybackControl
import pw.binom.VideoClientHandlerImpl
import pw.binom.ViewManager
import pw.binom.dto.AndroidVideoClient
import pw.binom.dto.Config
import pw.binom.dto.VideoPlaybackControl
...
class MyActivity2 : BaseEventActivity() {
...
//    val path = Uri.fromFile(File(pathStr))
    ...
    private var androidVideoClient: AndroidVideoClient? = null
