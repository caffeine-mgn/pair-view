...
import com.rayneo.arsdk.android.demo.GlUtil.checkGlError
import com.rayneo.arsdk.android.demo.GlUtil.checkLocation
import com.rayneo.arsdk.android.demo.GlUtil.createProgram
...
class Texture2dProgram(private val mProgramType: ProgramType) {
    ...
    init {
        ...
        FLogger.d(TAG, "Created program " + mProgramHandle + " (" + mProgramType + ")")
     ...
     */
    fun release() {
        FLogger.d(TAG, "deleting program " + mProgramHandle)
