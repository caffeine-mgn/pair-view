...
object GlUtil {
    ...
    fun createProgram(vertexSource: String?, fragmentSource: String?): Int {
        ...
        if (program == 0) {
            FLogger.e(TAG, "Could not create program")
        }
        ...
        if (linkStatus[0] != GLES20.GL_TRUE) {
            FLogger.e(TAG, "Could not link program: ")
            FLogger.e(TAG, GLES20.glGetProgramInfoLog(program))
    ...
    fun loadShader(shaderType: Int, source: String?): Int {
        ...
        if (compiled[0] == 0) {
            FLogger.e(TAG, "Could not compile shader $shaderType:")
            FLogger.e(TAG, " " + GLES20.glGetShaderInfoLog(shader))
     ...
     */
    fun logVersionInfo() {
        FLogger.i(TAG, "vendor  : " + GLES20.glGetString(GLES20.GL_VENDOR))
        FLogger.i(TAG, "renderer: " + GLES20.glGetString(GLES20.GL_RENDERER))
        FLogger.i(TAG, "version : " + GLES20.glGetString(GLES20.GL_VERSION))
        ...
        if (false) {
            ...
            if (GLES30.glGetError() == GLES30.GL_NO_ERROR) {
                FLogger.i(TAG, "iversion: $majorVersion.$minorVersion")
            }
        }
    }
}